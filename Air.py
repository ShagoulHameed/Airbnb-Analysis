...
if selected_option == "Home":
    ...
    st.write("""
        **Airbnb** is an online marketplace that connects people who want to rent out their property with people looking for accommodations, typically for short stays.
    """)
...
if selected_option == "Data Exploration":
    ...
    with tab3:
        ...
        room_type_l = st.selectbox("Select the Room Type", property_location_df["room_type"].unique(), key="room_type_l")  # Add this line
        ...
        if selected_price_range:
            ...
            # Adding the missing code for selecting room type
